...
const KYC_CONFIG = {
  ...
  pending:    { label: 'Under Review',  bg: 'rgba(14,164,171,0.12)', text: '#0EA4AB',  border: 'rgba(14,164,171,0.25)', icon: Shield      },
        ...
        >
          ...
          <div className="flex justify-center lg:justify-start">
            <div
              ...
              style={{ background: 'linear-gradient(135deg, rgba(14,164,171,0.3), rgba(197,227,91,0.1))' }}
            >
              {avatarSrc ? (
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-ink-secondary mb-4">
                Complete KYC to unlock spot trading, deposits, and withdrawals on IBO Exchange.
              </p>
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl p-6 space-y-3"
        ...
        {[
          ...
          'Never share your password with anyone, including IBO support',
