      ...
      <div className="w-full px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6 sm:py-8 pb-16">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          ...
          <Link to="/p2p"
            ...
            className="ibo-hover-border inline-flex items-center gap-2 rounded-xl border border-[color:var(--ibo-border-solid)] bg-transparent px-4 py-2.5 text-sm font-semibold text-white/70 hover:text-white">
        ...
        <div className="mb-5 grid grid-cols-2 gap-1 rounded-xl border border-[color:var(--ibo-border-solid)] bg-transparent p-1 sm:grid-cols-3 xl:grid-cols-6">
            ...
            <button key={t.key} type="button" onClick={() => setTab(t.key)}
              ...
              className={`w-full rounded-lg px-3 py-2.5 text-center text-sm font-bold whitespace-nowrap transition-colors ${
                ...
                tab === t.key
                  ...
                  ? 'bg-[#FE6C02]/15 text-[#FE9D55] border border-[#FE6C02]/30'
        ...
        <div className="flex items-center gap-3 mb-5 flex-wrap">
          ...
          <div className="relative min-w-[220px] flex-1">
            ...
            <input value={search} onChange={(e) => setSearch(e.target.value)}
              ...
              className="w-full rounded-xl bg-transparent border border-[color:var(--ibo-border-solid)] pl-9 pr-3.5 py-2.5 text-sm text-[color:var(--ibo-ink)] placeholder:text-[color:var(--ibo-muted)] focus:outline-none focus:border-[rgba(254, 157, 85,0.55)] transition-colors"
          ...
          <button type="button" onClick={load} disabled={loading}
            ...
            className="inline-flex items-center gap-1.5 rounded-xl border border-[color:var(--ibo-border-solid)] bg-transparent px-4 py-2.5 text-sm font-semibold text-[color:var(--ibo-ink-secondary)] hover:bg-[color:var(--ibo-hover)] hover:text-[color:var(--ibo-ink)] transition-colors disabled:opacity-40">
              ...
              <thead>
                ...
                <tr style={{ borderBottom: '1px solid var(--ibo-border-solid)', background: 'transparent' }}>
                  ...
                  {['Order ID', 'Type', 'Crypto', 'Fiat (₹)', 'Method', 'Date', 'Status', ''].map((h, i) => (
                    ...
                    <th key={h+i} className="px-5 py-3.5 text-left text-[10px] font-bold uppercase tracking-widest text-[color:var(--ibo-muted)]">{h}</th>
              ...
              <tbody>
                ...
                {loading ? (
                  ...
                  <tr><td colSpan={8} className="px-5 py-16 text-center">
                    ...
                    <Link to="/p2p" className="inline-flex items-center gap-1.5 mt-3 text-[#FE9D55] text-sm hover:underline">
