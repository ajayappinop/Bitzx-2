...
const PM_META = {
  ...
  IMPS:    { icon: CreditCard,  color: '#FE6C02', bg: 'rgba(254, 108, 2,0.1)', border: 'rgba(254, 108, 2,0.25)', label: 'IMPS' },
  BANK:    { icon: Building2,   color: '#FE6C02', bg: 'rgba(167,139,250,0.1)',border: 'rgba(254, 108, 2,0.25)',label: 'Bank Transfer' },
...
const inp = 'w-full rounded-xl bg-transparent border border-[color:var(--ibo-border-solid)] px-3.5 py-2.5 text-[color:var(--ibo-ink)] text-sm placeholder:text-[color:var(--ibo-muted)] focus:outline-none focus:border-[rgba(254, 157, 85,0.55)] transition-colors';
    ...
    <div className="ibo-page font-ui">
      <div className="w-full px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6 sm:py-8 pb-16">
        ...
        {methods === null ? (
          ...
          <div className="rounded-xl border border-dashed border-[color:var(--ibo-border-solid)] p-16 text-center">
            <div className="w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center"
              style={{ background: 'rgba(254, 108, 2,0.08)', border: '1px solid rgba(254, 108, 2,0.15)' }}>
              <CreditCard size={22} className="text-[#FE9D55]/60" />
            </div>
            ...
            <button onClick={openAdd}
              className="inline-flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-bold text-[#101013]"
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-4">
            {methods.map((m) => {
              ...
              return (
                <div key={m.pm_id}
                  className="ibo-hover-lift ibo-hover-glow rounded-xl border p-5 space-y-3.5"
                  style={{ background: 'transparent', borderColor: 'var(--ibo-border-solid)' }}>
                      ...
                      m.verified
                        ? (
                          ...
                          <div className="flex items-center gap-1 text-[10px] font-bold text-gold px-2 py-0.5 rounded-full"
                            style={{ background: 'rgba(0, 168, 118,0.1)', border: '1px solid rgba(0, 168, 118,0.25)' }}>
