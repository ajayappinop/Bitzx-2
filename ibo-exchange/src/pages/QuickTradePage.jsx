    ...
    <motion.button
      ...
      style={{
        ...
        background: isSelected
          ? 'linear-gradient(135deg, rgba(254, 157, 85,0.14), rgba(254, 108, 2,0.08))'
          : 'var(--ibo-card)',
        borderStyle: 'solid', borderWidth: 1,
        borderColor: isSelected ? 'rgba(254, 157, 85,0.5)' : 'var(--ibo-border-solid)',
        boxShadow: isSelected ? '0 8px 24px rgba(254, 157, 85,0.12)' : 'var(--ibo-shadow)',
    ...
    >
      <div style={{ position: 'relative', flexShrink: 0 }}>
        {icon
          ...
          : <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(254, 157, 85,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, color: '#FE9D55', fontSize: 11 }}>{base[0]}</div>
        }
        {isSelected && (
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: isSelected ? '#FE9D55' : 'var(--ibo-ink)', lineHeight: 1.15, fontFamily: "Inter, 'Plus Jakarta Sans', system-ui, sans-serif" }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '10px 14px', textAlign: 'center' }}>
        <Link to="/trade/IBOUSDT" style={{ fontSize: 12, color: '#FE9D55', fontWeight: 600, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 4 }}
  ...
  return (
    <div className="ibo-page font-ui">
      ...
      <div className="fixed inset-0 pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse 70% 45% at 70% -5%, rgba(254, 108, 2,0.1), transparent 55%), radial-gradient(ellipse 50% 40% at 10% 20%, rgba(254, 157, 85,0.07), transparent 50%)',
        }} />
                ...
                return (
                  <button key={pair.symbol}
                    ...
                    style={{
                      ...
                      background: isSel ? 'linear-gradient(135deg, rgba(254, 157, 85,0.14), rgba(254, 108, 2,0.08))' : 'transparent',
                    ...
                    <div style={{ position: 'relative', flexShrink: 0 }}>
                      {ico
                        ...
                        : <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'rgba(254, 157, 85,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, color: '#FE9D55', fontSize: 12 }}>{b[0]}</div>
                      }
                    ...
                    {/* Name */}
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 13, fontWeight: 700, color: isSel ? '#FE9D55' : 'var(--ibo-ink)', lineHeight: 1.15, fontFamily: "Inter, 'Plus Jakarta Sans', system-ui, sans-serif" }}>
                    ...
                    <button
                      ...
                      <Star size={13} color="#FE9D55" fill={isFav ? '#FE9D55' : 'none'} />
                    </button>
                  </button>
                );
              })}
      ...
      <div className="relative z-10 w-full px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-4 sm:py-5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
              style={{ background: 'linear-gradient(135deg, #FE6C02, #FE9D55)', boxShadow: '0 6px 14px rgba(254, 108, 2,0.22)' }}>
              <Zap size={15} color="#101013" />
            </div>
            <div>
          ...
          <Link to="/trade/IBOUSDT"
            className="font-ui flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12px] font-semibold
              ...
              bg-[color:var(--ibo-card)] hover:border-[rgba(254, 157, 85,0.45)]">
        ...
        <button
          ...
          {icon
            ...
            : <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'rgba(254, 157, 85,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, color: '#FE9D55', fontSize: 12, flexShrink: 0 }}>{base[0]}</div>
          }
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
            ...
            <ChevronDown size={16} color="#FE9D55" />
          </div>
        </button>
            ...
            {sortedPairs.map(pair => (
              <div key={pair.symbol} style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  <Star size={12} color="#FE9D55" fill={favs.includes(pair.symbol) ? '#FE9D55' : 'none'} />
                </button>
              </div>
            ))}
          </div>
              ...
              <div className="p-3.5 sm:p-4 space-y-3.5">
                  ...
                  {PCTS.map(({ label, v }) => (
                    <button
                      ...
                      className="font-ui h-8 text-[11px] font-semibold rounded-md transition-all
                        ...
                        hover:bg-[rgba(254, 157, 85,0.12)] hover:text-[#FE9D55] hover:border-[rgba(254, 157, 85,0.4)]"
                    >
                      {label}
                    </button>
                  ))}
                  ...
                  <AnimatePresence>
                    <motion.div
                      ...
                      {[
                        ...
                        { label: 'Fee (0.1%)',  value: `$${fee.toLocaleString(undefined, { maximumFractionDigits: 4 })} USDT`, color: '#FE6C02' },
                      ].map(row => (
                ...
                {kycBlocked && (
                  <div className="rounded-lg p-3 flex items-start gap-2.5"
                    style={{ background: 'rgba(254, 108, 2,0.08)', border: '1px solid rgba(254, 108, 2,0.22)' }}>
                  ...
                  <div className="space-y-2 pt-0.5">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Link to="/login"
                        ...
                        style={{ background: 'linear-gradient(135deg, #FE6C02, #FE9D55)', color: '#101013' }}>
                        Log In
                      </Link>
                      <Link to="/register"
