 ...
 * PARKED — Classic Delta registration UI (temporarily disabled).
...
const PERKS = [
  ...
  { icon: Star, color: '#FE6C02', title: 'Low Fees — 0.1%', desc: 'Maker & taker fee, no hidden charges' },
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
          ...
          <form noValidate onSubmit={handleCreateAccount} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center rounded-xl border border-surface-border px-3.5 h-12 focus-within:border-[#FE6C02]/50 transition-colors group">
            ...
            >
              ...
              {loading
                ...
                ? <div className="w-5 h-5 border-2 border-[#101013] border-t-transparent rounded-full animate-spin" />
          ...
          <p className="text-center text-[color:var(--ibo-muted)] text-sm mt-5">
            ...
            <Link to="/login" className="text-[#FE9D55] font-bold hover:underline">Sign In</Link>
