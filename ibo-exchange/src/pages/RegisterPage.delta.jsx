  ...
  return (
    ...
    <button
      ...
      className="flex-shrink-0 px-3 sm:px-4 h-12 rounded-xl text-xs sm:text-sm font-bold
        ...
        border border-[#FE6C02]/40 text-[#00A876] bg-[#FE6C02]/10

        hover:bg-[#FE6C02]/20 active:scale-[0.98] transition-all disabled:opacity-40 disabled:pointer-events-none"

    >

      {loading ? (

        <span className="inline-block w-4 h-4 border-2 border-[#00A876] border-t-transparent rounded-full animate-spin" />
...
export default function RegisterPage() {
  ...
  // â”€â”€ OTP service flags (from /api/public/site-config) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        <AuthPromoPanel
          ...
          items={[

            {
              ...
              desc: 'Fund via bank or UPI and withdraw INR after selling â€” no crypto ownership required to start learning.',
    ...
    >
      ...
      <p className="text-[14px] text-zinc-400 mb-7">
        ...
        {serviceConfigLoaded && !emailOtpEnabled && !smsOtpEnabled
          ...
          ? 'Free demo Â· Verify email and phone later from Profile'

          : 'Free demo Â· No deposit required'}
      ...
      {success ? (
        ...
        <div className="flex items-start gap-2.5 rounded-xl border border-green-500/25 bg-green-500/10 px-3.5 py-3 mb-5 text-sm text-green-300">
          ...
          <form noValidate onSubmit={handleCreateAccount} className="space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className={`flex items-center rounded-xl border px-3.5 h-12 transition-colors group ${
                  ...
                  showFieldError('name') ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'

                }`}>

                  <User size={16} className="text-zinc-500 mr-2.5 group-focus-within:text-[#FE6C02] transition-colors" />
              ...
              <div className="sm:col-span-2">
                ...
                <label className="block text-[13px] font-semibold text-zinc-300 mb-2">
                  ...
                  {serviceConfigLoaded && !emailOtpEnabled && (
                    ...
                    <span className="ml-2 text-xs font-normal text-[#00A876]/90">(OTP verification currently inactive)</span>
                ...
                <div className="flex gap-2">
                  ...
                  <div className={`flex-1 flex items-center rounded-xl border px-3.5 h-12 transition-colors group ${
                    ...
                    showFieldError('email') ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'

                  }`}>

                    <Mail size={16} className="text-zinc-500 mr-2.5 group-focus-within:text-[#FE6C02] transition-colors" />
                ...
                {emailOtpEnabled && emailOtpSent && !emailVerified && (
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <div className={`flex-1 flex items-center rounded-xl border px-3.5 h-12 ${
                      ...
                      fieldErrors.emailOtp ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'
                    ...
                    <button
                      ...
                      className="flex-shrink-0 px-4 py-3 rounded-xl text-sm font-bold
                        ...
                        bg-logo-gradient text-[#101013] disabled:opacity-40"

                    >

                      {emailVerifyLoading ? (

                        <span className="inline-block w-4 h-4 border-2 border-[#101013] border-t-transparent rounded-full animate-spin" />
                ...
                {serviceConfigLoaded && !emailOtpEnabled && (
                  ...
                  <div className="rounded-xl border border-[#FE6C02]/25 bg-[#FE6C02]/[0.08] px-4 py-3 mt-2 text-xs text-[#00A876]/80 leading-relaxed">
            ...
            {/* â”€â”€ Mobile â€” OTP controls only when SMS service is on â”€â”€ */}
            ...
            <div>
              ...
              <label className="block text-[13px] font-semibold text-zinc-300 mb-2">
                ...
                {smsOtpEnabled ? (
                  ...
                  <span className="ml-2 text-xs font-normal text-[#00A876]/90">(SMS verification inactive)</span>
              ...
              <div className="flex gap-2">
                ...
                <div className={`flex-1 flex items-center rounded-xl border px-3.5 h-12 transition-colors group ${
                  ...
                  showFieldError('mobile') ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'

                }`}>

                  {countryCode ? (

                    <span className="text-sm font-bold text-[#00A876] mr-2 tabular-nums">+{countryCode}</span>

                  ) : null}

                  <Phone size={16} className="text-zinc-500 mr-2 group-focus-within:text-[#FE6C02] transition-colors" />
                ...
                <p className="text-[11px] text-zinc-500 mt-1.5">
                  ...
                  {smsVerified
                    ...
                    : smsOtpSent
                      ...
                      : 'Enter a valid 10-digit number and tap Send OTP â€” no need to verify email first.'}
              ...
              {smsOtpEnabled && smsOtpSent && !smsVerified && (
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  <div className={`flex-1 flex items-center rounded-xl border px-3.5 h-12 ${
                    ...
                    fieldErrors.smsOtp ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'
            ...
            <div>
              ...
              <div className="flex items-center rounded-xl border border-white/[0.1] bg-white/[0.03] px-3.5 h-12 focus-within:border-[#FE6C02]/50 transition-colors group">

                <Gift size={16} className="text-zinc-500 mr-2.5 group-focus-within:text-[#FE6C02] transition-colors" />
            ...
            <div>
              ...
              <div className={`flex items-center rounded-xl border px-3.5 h-12 transition-colors group ${
                ...
                showFieldError('password') ? 'border-red-500/50 bg-red-500/[0.04]' : 'border-white/[0.1] bg-white/[0.03] focus-within:border-[#FE6C02]/50'

              }`}>

                <Lock size={16} className="text-zinc-500 mr-2.5 group-focus-within:text-[#FE6C02] transition-colors" />
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <div className="mt-0.5 flex-shrink-0">
                ...
                <input
                  ...
                  className="w-4 h-4 rounded border-white/[0.1] bg-white/[0.03] accent-[#FE6C02] cursor-pointer"
              ...
              <span className="text-[12px] text-zinc-400 leading-relaxed">
                ...
                <Link
                  ...
                  className="text-[#00A876] hover:underline"
            ...
            <label className="flex items-start gap-2.5 cursor-pointer">
              ...
              <span className="text-[12px] leading-relaxed text-zinc-400">
                ...
                I confirm that I am not a resident of a restricted jurisdiction and am eligible to use Delta Exchange services.
