...
export default function ResetPasswordPage() {
  ...
  return (
    <AuthShell
      side={
        <AuthPromoPanel
          ...
          subtitle="Pick something unique to IBO Exchange — then log in and continue trading."
          items={[
            {
    ...
    >
      ...
      {!token && !done ? (
        <div className="rounded-xl border border-[#0ea4ab]/25 bg-[#0ea4ab]/10 px-4 py-3 mb-5 text-sm text-[#C5E35B]/90">
