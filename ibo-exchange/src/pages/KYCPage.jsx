...
const KYC_BENEFITS = [
  ...
  { icon: CheckCircle, color: '#00A876', title: 'Account Protection',    desc: 'Identity verified, funds stay safe' },

  { icon: Globe,       color: '#FE6C02', title: 'Regulatory Compliance', desc: 'Meet global exchange requirements' },
...
function StatusBanner({ kyc }) {
  ...
  const config = {
    ...
    pending:  { icon: Clock,       color: '#FE6C02', bg: 'rgba(254, 108, 2,0.08)',  border: 'rgba(254, 108, 2,0.25)',
    ...
    digilocker_pending: { icon: Clock, color: '#FE6C02', bg: 'rgba(254, 108, 2,0.08)', border: 'rgba(254, 108, 2,0.25)',

                title: 'DigiLocker in progress',

                msg: 'Finish authorization in the DigiLocker tab. This page updates when step 1 is complete.' },

    awaiting_pan: { icon: CreditCard, color: '#FE6C02', bg: 'rgba(254, 108, 2,0.08)', border: 'rgba(254, 108, 2,0.25)',
        ...
        <div key={label} className="flex items-center flex-1 last:flex-none min-w-[80px]">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center font-bold transition-all ${
              ...
              style={i === current ? { background: 'linear-gradient(135deg, #FE6C02, #00A876)' } : {}}>
          ...
          {DOC_TYPES.map(({ value, label, emoji, desc }) => (
            ...
            <button key={value} type="button" onClick={() => onChange('document_type', value)}
              ...
              style={data.document_type === value
                ...
                ? { background: 'rgba(254, 108, 2,0.12)', border: '1px solid rgba(254, 108, 2,0.4)' }
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            {camState === 'live' && (
              ...
              <button type="button" onClick={takePhoto}
                ...
                style={{ background: 'linear-gradient(135deg, #FE6C02, #00A876)' }}>
      ...
      <div className="rounded-2xl p-6 space-y-4"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
            ...
            style={{ background: 'rgba(167,139,250,0.12)', border: '1px solid rgba(254, 108, 2,0.25)' }}>
    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl p-6 space-y-4"
        ...
        {isPending && !digiUrl && !syncError && (
          ...
          <div className="rounded-xl px-4 py-2.5 text-sm text-gold-light"
            ...
            style={{ background: 'rgba(254, 108, 2,0.1)', border: '1px solid rgba(254, 108, 2,0.25)' }}>
      ...
      <div className="rounded-2xl p-5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
        ...
        <ol className="space-y-1.5 text-sm text-white/60 list-decimal list-inside">
          ...
          <li>Grant consent to share your Aadhaar details with Delta.</li>
    ...
    <div className="ibo-page font-ui flex flex-col xl:flex-row">
      ...
      <div className="hidden xl:flex flex-col w-[400px] flex-shrink-0
        ...
        <div className="absolute inset-0 pointer-events-none"
          ...
          style={{ background: 'radial-gradient(ellipse at 20% 20%, rgba(254, 108, 2,0.14) 0%, transparent 55%), radial-gradient(ellipse at 80% 90%, rgba(0, 168, 118,0.08) 0%, transparent 45%)' }} />
        ...
        <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center"
            ...
            style={{ background: 'rgba(254, 108, 2,0.15)', border: '1px solid rgba(254, 108, 2,0.35)' }}>
          ...
          {(kycMode === 'auto' ? autoSteps : STEPS).map(({ label, icon: Icon }, i) => (
            ...
            <div key={label} className="flex items-center gap-3">
              ...
              <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold ${
                ...
                style={i === (kycMode === 'auto' ? autoStepIndex : step) ? { background: 'linear-gradient(135deg, #FE6C02, #00A876)' }
          ...
          {submitted && (
            ...
            <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }}
              ...
              <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto"
                ...
                style={{ background: 'rgba(254, 108, 2,0.15)', border: '1px solid rgba(254, 108, 2,0.3)' }}>
