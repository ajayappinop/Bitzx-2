...
const PIE_COLORS = ['#0EA4AB', '#3b82f6', '#0EA4AB', '#10b981', '#0EA4AB', '#ef4444', '#1B5FFF', '#ec4899', '#14b8a6', '#f97316'];
    ...
    <div className="space-y-6">
      <div className="ibo-hover-lift ibo-hover-glow bg-surface-DEFAULT border border-surface-border rounded-2xl p-6">
        ...
        <p className="text-white/45 text-xs mt-2">
          USD values use live quotes from markets (IBO internal ticker, others via exchange feed).
        </p>
      </div>
      ...
      <div className="w-full px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-8 sm:py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { icon: TrendingUp, label: 'IBO holdings', value: `${(walletAssets.find(w => w.asset === 'IBO')?.available || 0).toLocaleString(undefined, { maximumFractionDigits: 0 })} IBO`, color: 'text-blue-400' },
