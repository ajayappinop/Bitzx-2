            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
              <button
                ...
                style={{
                  ...
                  color: canSell ? '#5BB8FF' : 'var(--ibo-muted)',
                  background: canSell ? 'rgba(91,184,255,0.12)' : 'var(--ibo-elevated)',
                  border: `1px solid ${canSell ? 'rgba(91,184,255,0.35)' : 'var(--ibo-border)'}`,
...
function BottomPanel({ symbol, isIboMock = false, iboTrades = [], iboLoading = false }) {
  ...
  const TABS = [
    ...
    { id: 'trades',    label: 'Recent trades',  badge: null },
  ];
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-[color:var(--ibo-surface)]">
      ...
      <div
        ...
        style={{ position: 'sticky', top: 0, zIndex: 90, background: 'var(--ibo-surface)' }}
      >
        {TABS.map(t => {
          const on = tab === t.id;
          return (
          <button key={t.id} type="button" onClick={() => setTab(t.id)}
            ...
            {t.label}
            {t.badge > 0 && (
              <span style={{ fontSize: 10, background: 'rgba(197,227,91,0.15)', color: ACCENT, padding: '2px 8px', borderRadius: 6, fontWeight: 800 }}>
                {t.badge}
              </span>
            )}
            {on ? (
      ...
      <div className="flex-1 min-h-0 overflow-auto scrollbar-hide flex flex-col">
      {tab === 'positions' && (
        <TabHint>
              ...
              >
                ...
                {[
                  ...
                  <button
                    ...
                    style={{
                      border: `1px solid ${orderFilter === f.id ? 'rgba(197,227,91,0.45)' : 'var(--ibo-border)'}`,
                      background: orderFilter === f.id ? 'rgba(197,227,91,0.14)' : 'var(--ibo-elevated)',
                ...
                <div key={o.id}
                  ...
                  {histPnl ? (
                    ...
                    <>
                      ...
                      <span style={{ textAlign: 'right', fontFamily: 'Inter, Plus Jakarta Sans, sans-serif', fontSize: 13, color: '#5BB8FF', fontWeight: 700 }}>
...
export default function TradePage() {
  ...
  return (
    <div style={{ background: 'var(--ibo-bg)' }}>
      ...
      <div className="flex flex-col md:hidden min-h-[calc(100vh-70px)]">
        ...
        <div style={{
          padding: '8px 12px',
          borderBottom: '1px solid var(--ibo-border)',
          background: 'var(--ibo-surface)', position: 'relative', zIndex: 200,
        }}>
        ...
        <div style={{
          display: 'flex', background: 'var(--ibo-surface)',
          borderBottom: '1px solid var(--ibo-border)',
      ...
      >
        ...
        <div style={{
          ...
          padding: '6px 12px',
          borderBottom: '1px solid var(--ibo-border)',
          background: 'var(--ibo-surface)', flexShrink: 0,
          ...
          {activeTicker ? (
            <>
              ...
              <div className="hidden lg:flex items-center">
                ...
                <StatItem label="Quote Vol"  value={apiQuote === 'IBO' ? `${fmtVol(activeTicker.quoteVolume)} IBO` : `$${fmtVol(activeTicker.quoteVolume)}`} />
              </div>
            </>
          ) : (
        ...
        <div className="flex flex-1 min-h-[320px] lg:min-h-[380px] xl:min-h-0">
          ...
          <div className="flex flex-col w-[280px] lg:w-[300px] xl:w-[320px] shrink-0 border-r border-[color:var(--ibo-border)] min-h-0 bg-[color:var(--ibo-surface)]">
          ...
          <div className="flex flex-col w-[280px] lg:w-[300px] xl:w-[340px] shrink-0 overflow-hidden bg-[color:var(--ibo-surface)]">
        ...
        <div className="shrink-0 h-[148px] lg:h-[168px] xl:h-[200px] 2xl:h-[22vh] 2xl:min-h-[180px] 2xl:max-h-[260px] border-t border-[color:var(--ibo-border)] overflow-hidden">
          <BottomPanel
            symbol={symbol}
            isIboMock={isIboMock}
            iboTrades={iboTrades}
