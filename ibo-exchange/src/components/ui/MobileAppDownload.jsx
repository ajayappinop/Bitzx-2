...
export default function MobileAppDownload({
  ...
  const heading = title || (isGooglePlay ? 'Delta on Google Play' : 'Download Delta Mobile');

  const desc = subtitle || (available

    ? (isGooglePlay

      ? 'Install the official Delta app from Google Play — trade on Android anytime.'
    ...
    if (resolvedVariant === 'banner') {
      ...
      return (
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.14) 0%, rgba(10,11,15,0.95) 55%, rgba(254, 108, 2,0.08) 100%)' }}
              ...
              <div>
                ...
                <p className="text-[11px] text-zinc-500 mt-3 flex items-center gap-1.5">
                  ...
                  {isGooglePlay
                    ...
                    ? 'Official Delta app on Google Play'

                    : 'Official Delta APK · enable “Install unknown apps” if prompted'}
          ...
          <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-zinc-500 mt-2 flex items-center gap-1.5">
                ...
                {isGooglePlay ? 'Official app on Google Play' : 'Official APK from Delta'}
    ...
    <motion.div
      ...
      style={{
        ...
        background:
          ...
          'linear-gradient(145deg, rgba(254, 108, 2,0.12) 0%, color-mix(in srgb, var(--ibo-card) 94%, transparent) 48%, rgba(0, 168, 118,0.1) 100%)',
      ...
      <div className={`relative flex items-start gap-3 ${isBanner || !isCompact ? 'p-5 sm:p-6' : 'p-4 sm:p-5'}`}>
        ...
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(145deg, rgba(254, 108, 2,0.2) 0%, rgba(0, 168, 118,0.1) 100%)',

            borderColor: 'rgba(254, 108, 2,0.35)',

            color: 'var(--ibo-accent)',

            boxShadow: '0 8px 20px rgba(254, 108, 2,0.15)',
