...
const IBO_TOKEN_ICON = '/hero/ibo-token-3d.png?v=12';
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 mb-3 sm:mb-4">
        <span className="h-4 w-[3px] rounded-full bg-[#FE6C02] shrink-0" aria-hidden />
        <h3
          ...
          <h2 className="ibo-title-lg">
            ...
            <span className="relative inline-block">
              ...
              <span
                ...
                style={{ background: 'linear-gradient(90deg, #4D8AFF, #FE6C02)' }}
              />
            </span>
          </h2>
          {showViewAll ? (
