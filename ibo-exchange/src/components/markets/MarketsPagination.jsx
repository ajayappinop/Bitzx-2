  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center justify-center gap-3 py-4 ${className}`}>
      ...
      <button
        ...
        onClick={onLoadMore}
        disabled={loading}
        className="font-ui inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-[rgba(91,184,255,0.4)] bg-[rgba(91,184,255,0.1)] text-[#5BB8FF] text-sm font-bold hover:bg-[rgba(91,184,255,0.18)] disabled:opacity-50 transition-colors"
      >
