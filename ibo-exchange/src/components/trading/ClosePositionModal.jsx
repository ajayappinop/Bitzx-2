    ...
    >
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4 text-sm">
          ...
          {locked > 1e-8 && (
            <div
              className="flex gap-2 items-start rounded-xl px-3 py-2.5 text-[#FE9D55]/95"
              ...
              {['market', 'limit'].map(t => (
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-xl font-bold capitalize transition-colors ${
                    orderType === t
                      ? 'bg-[rgba(254, 157, 85,0.15)] text-[#FE9D55] border border-[rgba(254, 157, 85,0.4)]'
          ...
          {orderType === 'limit' && (
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl bg-[color:var(--ibo-elevated)] border border-[color:var(--ibo-border-solid)] px-4 py-3 font-mono text-[color:var(--ibo-ink)] focus:outline-none focus:border-[rgba(254, 157, 85,0.55)]"
                placeholder="0.00"
              />
            </div>
          )}
          ...
          <div>
              ...
              {[
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-extrabold uppercase tracking-wide ${
                    sizeMode === id
                      ? 'bg-[rgba(254, 157, 85,0.15)] text-[#FE9D55] border border-[rgba(254, 157, 85,0.35)]'
                      : 'bg-white/[.04] text-white border border-transparent hover:text-white'
                  }`}
                >
                  {label}
            ...
            {sizeMode === 'amount' && (
              <input
                ...
                className="mt-2 w-full rounded-xl bg-[color:var(--ibo-elevated)] border border-[color:var(--ibo-border-solid)] px-4 py-3 font-mono text-[color:var(--ibo-ink)] focus:outline-none focus:border-[rgba(254, 157, 85,0.55)]"
