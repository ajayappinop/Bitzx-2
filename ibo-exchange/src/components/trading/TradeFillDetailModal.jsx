  ...
  return (
    <span className="inline-flex items-center gap-2">
      ...
      <button
        ...
        className="p-1 rounded text-white/60 hover:text-[#5BB8FF] transition-colors"
        aria-label="Copy"
      >
      ...
      >
        ...
        <div className="px-5 py-4 border-t border-white/[.06] flex flex-wrap gap-3">
          <Link
            ...
            onClick={onClose}
            className="inline-flex items-center gap-2 text-sm font-bold text-[#5BB8FF] hover:underline"
          >
