/**
 * Delta Exchange–inspired auth chrome (Delta theme).
 ...
 * Keeps Delta brand colors (cyan / lime) instead of Delta orange.
 */
      ...
      <div
        className={`ibo-auth-field flex items-center h-12 rounded-xl border px-3.5 transition-colors ${
          error
            ...
            : 'border-[color:var(--ibo-border-solid)] bg-[color:var(--ibo-elevated)] focus-within:border-[#FE6C02]/50'
        }`}
      >
        ...
        <input
          ...
          className="ibo-auth-input flex-1 min-w-0 bg-transparent text-[15px] text-[color:var(--ibo-ink)] outline-none placeholder:text-[color:var(--ibo-muted)] disabled:opacity-60 caret-[#00A876]"
        />
        {rightSlot}
      </div>
      {error ? (
