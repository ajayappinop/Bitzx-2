...
const FEATURES = [
  {
    ...
    desc: 'Pro matching for F&O — orders fill with low latency so you can react when the market moves.',
  ...
  },
  {
    ...
    desc: 'Pro charts with 100+ indicators, drawings, and multi-timeframe analysis for futures and options.',
  ...
  },
  {
    ...
    badge: 'Portfolio',
    title: 'Positions & P/L',
    desc: 'Track futures and options in one portfolio — margin and P/L ready for INR settlement rails.',
