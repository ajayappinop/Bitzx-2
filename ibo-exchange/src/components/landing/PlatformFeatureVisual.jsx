    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 55%, rgba(0, 168, 118,0.28) 0%, rgba(254, 108, 2,0.18) 42%, transparent 72%)',
          }}
        />
        <div
          aria-hidden
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 50%, rgba(249,179,43,0.22) 0%, rgba(132,204,22,0.2) 34%, rgba(254, 108, 2,0.12) 58%, transparent 78%)',
          }}
        />
