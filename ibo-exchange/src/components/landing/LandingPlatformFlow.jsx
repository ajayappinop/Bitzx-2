/**
 * Landing — IBO token spotlight + deposit → trade user journey (responsive).
 */
...
const IBO_POINTS = [
  { n: '01', title: 'Native quote asset', desc: 'Trade altcoins against IBO on dedicated IBO Markets — not only USDT.' },
  { n: '02', title: 'Platform utility', desc: 'Fees, ecosystem pairs, and featured listings revolve around the IBO token.' },
  { n: '03', title: 'Live IBO/USDT', desc: 'Spot market with full 24h stats, depth, and TradingView charts like any major pair.' },
];
...
const DEPOSIT_PATHS = [
  ...
  },
  {
    ...
    accent: 'rgba(197,227,91,0.4)',
    title: 'Listed project coins',
    desc: 'After listing approval, your token gets deposit, withdraw, and spot markets (USDT or IBO quote).',
    link: '/list-coin',
    cta: 'Apply to list',
  },
];
...
const JOURNEY_STEPS = [
  ...
  },
  {
    n: '03',
    title: 'Pick a market',
    desc: 'USDT pairs for majors, or IBO Markets for Web3 tokens quoted in IBO. Browse live 24h stats before you trade.',
    to: '/markets',
    cta: 'Browse markets',
    altTo: '/ibo-markets',
    altCta: 'IBO Markets',
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(14,164,171,0.22) 0%, rgba(77,138,255,0.1) 42%, transparent 70%)',
        }}
      />
      <div
        className="pointer-events-none absolute inset-[8%] rounded-full border border-white/[0.06]"
        style={{ boxShadow: 'inset 0 0 40px rgba(14,164,171,0.06)' }}
      />
      <img
        src={CUBES_ICON}
    ...
    <div className="space-y-0">
      ...
      >
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 55% 45% at 70% 40%, rgba(14,164,171,0.10) 0%, transparent 60%), radial-gradient(ellipse 40% 35% at 20% 75%, rgba(197,227,91,0.06) 0%, transparent 55%)',
          }}
        />
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] gap-10 lg:gap-6 xl:gap-10 items-center">
            ...
            >
              ...
              <h2 className="ibo-title-lg mb-4 max-w-xl">
                ...
                <span
                  ...
                  style={{
                    backgroundImage: 'linear-gradient(115deg, #4D8AFF 0%, #0EA4AB 45%, #C5E35B 100%)',
                  }}
                >
                  IBO
                </span>
              ...
              <p className="ibo-lead text-zinc-400 max-w-lg mb-8">
                IBO is our native token and quote currency for Web3 markets. Hold IBO to trade hundreds of
                project tokens, access IBO/USDT spot, and participate in the ecosystem we are building on BNB Chain.
              </p>

              <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-10">
                <Link
                  to="/trade/IBOUSDT"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-logo-gradient px-6 py-3.5 text-[15px] font-semibold text-surface-dark shadow-[0_12px_40px_rgba(14,164,171,0.25)]"
                >
                  Trade IBO/USDT <TrendingUp size={18} />
                </Link>
                <Link
                  to="/ibo-markets"
                ...
                >
                  Explore IBO Markets <ArrowRight size={18} className="text-[#0EA4AB]" />
                </Link>
              </div>
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'radial-gradient(circle, rgba(14,164,171,0.42) 0%, rgba(197,227,91,0.22) 38%, rgba(27,95,255,0.1) 58%, transparent 72%)',
                }}
              />
              <div
                aria-hidden
                ...
                style={{
                  background:
                    'radial-gradient(circle, rgba(14,164,171,0.5) 0%, rgba(197,227,91,0.28) 50%, transparent 70%)',
                }}
              />
              <div
                aria-hidden
                className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[88%] max-w-[420px] aspect-square rounded-full border border-[rgba(14,164,171,0.18)]"
                style={{ boxShadow: 'inset 0 0 50px rgba(14,164,171,0.1), 0 0 60px rgba(14,164,171,0.14)' }}
              />
              <div
                aria-hidden
                className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[68%] max-w-[320px] aspect-square rounded-full border border-[rgba(197,227,91,0.2)]"
                style={{ boxShadow: '0 0 36px rgba(197,227,91,0.12)' }}
              />
              <img
                src={IBO_TOKEN_3D}
                alt="IBO token"
      ...
      <section className="relative overflow-hidden" style={{ background: 'var(--ibo-bg)' }}>
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 50% 40% at 12% 25%, rgba(14,164,171,0.07) 0%, transparent 55%), radial-gradient(ellipse 40% 35% at 88% 70%, rgba(197,227,91,0.05) 0%, transparent 50%)',
          }}
        />
              ...
              >
                ...
                <Link
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, rgba(14,164,171,0.14) 0%, rgba(197,227,91,0.1) 100%)',
                    border: '1px solid rgba(14,164,171,0.35)',
                    boxShadow: '0 6px 18px rgba(14,164,171,0.12)',
                  }}
                >
        ...
        <div className="ibo-landing-container ibo-section-y">
          ...
          >
            ...
            <p className="ibo-lead-wide text-zinc-400 mx-auto">
              A clear, guided flow on web and mobile — the same steps whether you trade USDT pairs or IBO-quoted Web3 tokens.
            </p>
          </motion.div>
