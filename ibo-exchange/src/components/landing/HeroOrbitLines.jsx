        ...
        >
          <defs>
            <linearGradient id="hero-arc-a" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgba(254, 108, 2,0)" />
              <stop offset="25%" stopColor="rgba(254, 108, 2,0.55)" />
              <stop offset="55%" stopColor="rgba(77,138,255,0.45)" />
              <stop offset="100%" stopColor="rgba(0, 168, 118,0)" />
            </linearGradient>
            <linearGradient id="hero-arc-b" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="rgba(0, 168, 118,0)" />
              <stop offset="35%" stopColor="rgba(0, 168, 118,0.4)" />
              <stop offset="70%" stopColor="rgba(254, 108, 2,0.35)" />
          ...
          {!reduceMotion ? (
            <>
              <circle r="1.4" fill="#00A876" className="hero-orbit-travel-spark">
                <animateMotion
                  dur="16s"
              ...
              <circle r="1.1" fill="#FE6C02" className="hero-orbit-travel-spark" opacity="0.9">
                <animateMotion
                  dur="12s"
                  repeatCount="indefinite"
                  begin="-3s"
