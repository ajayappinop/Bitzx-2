...
const ITEMS = [
  ...
  },
  {
    ...
    glow: 'rgba(197,227,91,0.32)',
  },
  {
    to: '/wallet?tab=swap',
    label: 'Swap',
    sub: 'IBO ↔ USDT instant',
    icon: '/hero/ibo-token-3d.png?v=1',
    glow: 'rgba(14,164,171,0.38)',
  },
  {
    to: '/trade/IBOUSDT',
    label: 'Spot trade',
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 80% at 50% 0%, rgba(14,164,171,0.06) 0%, transparent 60%)',
        }}
      />
