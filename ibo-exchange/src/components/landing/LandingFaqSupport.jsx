...
const FAQS = [
  {
    q: 'Is IBO Exchange available in India?',
    a: 'Yes. IBO supports Indian users with Instant KYC (Aadhaar, PAN, face match) and INR deposit / payout flows alongside USDT and IBO trading pairs.',
  },
  {
    q: 'Do I need crypto to start trading?',
    a: 'No. You can deposit INR via bank or UPI, buy crypto on IBO, or start with a free demo balance to practice without depositing real funds.',
  },
  {
    q: 'Which assets can I trade?',
    a: 'Trade major USDT spot pairs, IBO-quoted markets, and deposit supported BEP-20 tokens. Full charts, depth, and portfolio P&L are available in one terminal.',
  },
  {
    q: 'How secure is my account?',
    a: 'IBO uses bank-grade security practices including cold-wallet custody for the majority of assets, 2FA, withdrawal whitelisting, and real-time monitoring.',
  },
  {
      ...
      >
        ...
        <span
          className={`shrink-0 grid place-items-center h-9 w-9 rounded-full border transition-colors ${
            open
              ? 'border-[#C5E35B]/50 bg-[#C5E35B]/15 text-[#C5E35B]'
              : 'border-[#0ea4ab]/40 bg-[#0ea4ab]/10 text-[#0ea4ab]'
          }`}
        >
          <ChevronDown
            size={18}
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 45% 55% at 15% 30%, rgba(14,164,171,0.1) 0%, transparent 55%), radial-gradient(ellipse 40% 50% at 90% 70%, rgba(197,227,91,0.06) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="relative ibo-landing-container ibo-section-y">
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.35fr)] gap-6 lg:gap-8 xl:gap-10 items-stretch">
          ...
          <motion.aside
            ...
            style={{
              borderColor: 'rgba(14,164,171,0.3)',
              background:
                'linear-gradient(155deg, rgba(14,164,171,0.16) 0%, color-mix(in srgb, var(--ibo-card) 92%, transparent) 45%, rgba(197,227,91,0.1) 100%)',
              boxShadow: '0 18px 48px rgba(14,164,171,0.1), var(--ibo-shadow)',
            }}
          >
            <div
              aria-hidden
              ...
              style={{
                background: 'linear-gradient(90deg, transparent, rgba(14,164,171,0.5), rgba(197,227,91,0.4), transparent)',
              }}
            />
            <div
              aria-hidden
              ...
              style={{
                background:
                  'repeating-radial-gradient(circle at center, transparent 0, transparent 14px, rgba(14,164,171,0.14) 14px, rgba(14,164,171,0.14) 15px)',
              }}
            />
            <div
              aria-hidden
              ...
              style={{
                background:
                  'radial-gradient(ellipse 55% 45% at 85% 90%, rgba(197,227,91,0.16) 0%, transparent 60%), radial-gradient(ellipse 40% 35% at 10% 15%, rgba(14,164,171,0.14) 0%, transparent 55%)',
              }}
            />
                  ...
                  <div className="flex flex-wrap items-center gap-2.5">
                    {SOCIAL.map((s) => (
                      <a
                        ...
                        className="inline-flex h-10 w-10 items-center justify-center rounded-full text-[#050a1a] hover:brightness-110 transition-[filter] shadow-[0_8px_24px_rgba(14,164,171,0.22)]"
                        style={{
                          background: 'linear-gradient(135deg, #0EA4AB 0%, #C5E35B 100%)',
                        }}
                      >
                        <s.icon size={15} />
                      </a>
