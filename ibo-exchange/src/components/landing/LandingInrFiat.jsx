/**
 * Landing — INR deposit & INR payout (sell IBO) for Indian users.
 */
...
export default function LandingInrFiat() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_15%_70%,rgba(14,164,171,0.1),transparent_50%)]" />
      ...
      <div className="relative ibo-landing-container ibo-section-y">
        ...
        >
          ...
          <p className="ibo-lead text-zinc-400 max-w-none">
            Add INR via bank or UPI and receive IBO after review. When you are ready to cash out, sell IBO and
        ...
        <div className="grid md:grid-cols-2 gap-5 lg:gap-6 max-w-5xl mx-auto">
          <motion.article
            ...
            style={{
              ...
              background:
                'linear-gradient(155deg, rgba(14,164,171,0.14) 0%, color-mix(in srgb, var(--ibo-card) 92%, transparent) 42%, rgba(197,227,91,0.08) 100%)',
          ...
          >
            <div
              ...
              style={{
                background: 'linear-gradient(90deg, transparent, rgba(14,164,171,0.55), transparent)',
              }}
            />
            <div
              aria-hidden
            ...
            <div className="relative flex items-center gap-3 mb-4">
              <div
                ...
                style={{
                  background: 'linear-gradient(145deg, rgba(14,164,171,0.22) 0%, rgba(14,164,171,0.08) 100%)',
                  borderColor: 'rgba(14,164,171,0.4)',
                  color: '#0ea4ab',
                  boxShadow: '0 8px 20px rgba(14,164,171,0.18)',
                }}
              >
                <ArrowDownCircle size={24} />
              </div>
              <div className="min-w-0">
                <p className="text-[11px] font-bold uppercase tracking-[0.16em]" style={{ color: '#0ea4ab' }}>
                  Deposit
                </p>
            ...
            >
              Transfer Indian Rupees using our payment details, submit your UTR and proof, and trade once IBO is
            ...
            <ul className="relative space-y-2.5 mb-6">
              {['Bank transfer or UPI', 'UTR + payment proof in wallet', 'IBO credited after admin review'].map((t) => (
                <li key={t} className="flex items-start gap-2.5 text-sm" style={{ color: 'var(--ibo-ink)' }}>
                  <CheckCircle size={15} className="shrink-0 mt-0.5" style={{ color: '#0ea4ab' }} />
                  {t}
                </li>
              ))}
            </ul>
            <Link
              ...
              className="relative inline-flex items-center justify-center gap-2 rounded-xl bg-logo-gradient px-6 py-3 text-[15px] font-semibold text-surface-dark w-full sm:w-auto shadow-[0_12px_28px_rgba(14,164,171,0.22)] hover:brightness-110 transition-[filter]"
            >
          ...
          <motion.article
            ...
            className="relative rounded-2xl border p-6 sm:p-8 flex flex-col h-full overflow-hidden transition-[border-color,box-shadow] duration-300"
            style={{
              borderColor: 'rgba(197,227,91,0.32)',
              background:
                'linear-gradient(155deg, rgba(197,227,91,0.14) 0%, color-mix(in srgb, var(--ibo-card) 92%, transparent) 42%, rgba(14,164,171,0.08) 100%)',
              boxShadow: '0 16px 40px rgba(197,227,91,0.08), var(--ibo-shadow)',
            }}
          >
            <div
              aria-hidden
              className="pointer-events-none absolute inset-x-0 top-0 h-px"
              style={{
                background: 'linear-gradient(90deg, transparent, rgba(197,227,91,0.55), transparent)',
              }}
            />
            <div
              aria-hidden
              className="pointer-events-none absolute -right-8 -top-10 w-40 h-40 rounded-full blur-3xl opacity-50"
              style={{ background: 'radial-gradient(circle, rgba(197,227,91,0.28) 0%, transparent 70%)' }}
            />
            ...
            <div className="relative flex items-center gap-3 mb-4">
              <div
                className="flex h-12 w-12 items-center justify-center rounded-xl border shrink-0"
                style={{
                  background: 'linear-gradient(145deg, rgba(197,227,91,0.28) 0%, rgba(197,227,91,0.08) 100%)',
                  borderColor: 'rgba(197,227,91,0.45)',
                  color: '#a8c73a',
                  boxShadow: '0 8px 20px rgba(197,227,91,0.18)',
                }}
              >
            ...
            <p
              ...
              style={{ color: 'var(--ibo-ink-secondary)' }}
            >
              Sell IBO from your wallet, request an INR payout to your verified bank or UPI, and track approval
              with payout reference in your history.
            </p>
            <ul className="relative space-y-2.5 mb-6">
              {['IBO reserved when you submit', 'INR to bank or UPI after review', 'Email updates on status'].map((t) => (
                <li key={t} className="flex items-start gap-2.5 text-sm" style={{ color: 'var(--ibo-ink)' }}>
            ...
            <Link
              ...
              style={{
                borderColor: 'rgba(197,227,91,0.4)',
                background: 'linear-gradient(135deg, rgba(197,227,91,0.16) 0%, rgba(14,164,171,0.1) 100%)',
                color: 'var(--ibo-ink)',
              }}
            >
