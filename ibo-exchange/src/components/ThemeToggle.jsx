 ...
 * Navbar / drawer control — switches Delta Exchange between dark and branded light.
  ...
  return (
    ...
    <button
      ...
      className={`inline-flex items-center justify-center gap-2 rounded-xl border transition-all
        ...
        hover:border-[#FE6C02]/45 hover:text-[color:var(--ibo-ink)]
    ...
    >
      ...
      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-logo-gradient text-[#101013] shrink-0">
