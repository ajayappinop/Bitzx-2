      ...
      {visible && (
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-sm rounded-2xl border border-[rgba(254, 157, 85,0.35)] bg-surface-card shadow-2xl p-6"
          ...
          >
            ...
            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[rgba(254, 157, 85,0.15)]">


              <Gift size={28} className="text-[#FE9D55]" />
            ...
            <div className="mt-6 flex flex-col gap-2">
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#FE6C02] to-[#FE9D55] py-3 text-sm font-bold text-surface-dark hover:bg-[rgba(254, 157, 85,0.9)] transition-colors"
