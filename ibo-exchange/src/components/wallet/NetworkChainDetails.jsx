...
const CHAIN_CHIP = {
  ...
  bsc: 'text-[#FE9D55] border-[rgba(254, 157, 85,0.35)] bg-[rgba(254, 157, 85,0.1)]',
    ...
    <div className="rounded-xl border border-[color:var(--ibo-border-solid)] bg-white/[0.03] overflow-hidden">
      <div className="px-4 py-3 border-b border-[color:var(--ibo-border-solid)] flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          ...
          {isPlanned ? (
            <span className="inline-flex items-center gap-1 rounded-full border border-[rgba(254, 157, 85,0.35)] bg-[rgba(254, 157, 85,0.1)] px-2.5 py-1 text-[10px] font-semibold text-[#FE9D55]">
              <Clock size={10} />
              Coming soon
            </span>
          ) : isLive ? (
